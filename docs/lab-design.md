...
graph TB
    ...
    subgraph LAB["Isolated lab segment — 10.10.10.0/24"]
        DC["dc01 · Windows Server 2022<br/>AD DS · DNS · GPO<br/>10.10.10.10"]
        WS["ws01 · Windows 11<br/>Domain-joined · Sysmon<br/>10.10.10.20"]
        SIEM["siem01 · Ubuntu Server<br/>Wazuh manager<br/>10.10.10.30"]
